...
/home/neon/venv/bin/python -m pip install git+https://github.com/mikejgray/neon-phal-plugin-audio-receiver
/home/neon/venv/bin/python -m pip install git+https://github.com/mikejgray/skill-mark2-audio-receiver/
